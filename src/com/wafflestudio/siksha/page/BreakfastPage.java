...
public class BreakfastPage extends LinearLayout {
  ...
  private void initSetting() {
    ...
    View view = inflater.inflate(R.layout.breakfast_page, this);

    indicator = (TextView) view.findViewById(R.id.breakfast_indicator);
    indicator.setTypeface(FontUtil.fontAPAritaDotumMedium);

    expandableListView = (ExpandableListView) view.findViewById(R.id.breakfast_expandable_list_view);
