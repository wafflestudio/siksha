...
public class ChildRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ChildRecyclerViewAdapter(Context context, Restaurant data) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int position) {
        if (!data.isEmpty) {
            ...
            menuViewHolder.priceView.setText(data.menus.get(position).price);
            menuViewHolder.nameView.setText(data.menus.get(position).name);
        }
    }
