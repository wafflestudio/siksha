...
public class JSONDownloader {
    ...
    private void compareLocalAndServerData(final UpdateCallback callback) {
        ...
        fetchJSONFromServer(new VolleyCallback() {
            ...
            public void onSuccess(String response) {
                String serverLatestData = new Gson().fromJson(response, DataVersion.class).latest;
    ...
    private void writeJSONOnInternalStorage(String data) {
        try {
            String fileName = action.equals(JSONDownloadReceiver.ACTION_INFORMATION_DOWNLOAD) ? "information.json" : "menus.json";
